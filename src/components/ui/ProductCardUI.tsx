        ...
        <Card className="bg-card border-border hover:shadow-xl transition-all duration-300">
          <CardContent className="p-4">
              ...
              <div className="aspect-square bg-muted rounded-md mb-3 overflow-hidden relative group">
                ...
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  {logic.discountPercentage && (
                    <span className="bg-destructive text-destructive-foreground text-xs px-2 py-1 rounded font-medium shadow">
                      -{logic.discountPercentage}%
                    </span>
                  )}
                  {logic.product.featured && (
                    <span className="bg-primary text-primary-foreground text-xs px-2 py-1 rounded font-medium shadow">
                      Destacado
                    </span>
                  )}
                  {!logic.inStock && (
            ...
            <div className="flex items-center justify-between">
              ...
              >
                {logic.inStock ? 'Adoptar' : 'No disponible'}
              </Button>
            </div>
          </CardContent>
        </Card>
